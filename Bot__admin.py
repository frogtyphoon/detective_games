...
bot_admin = [
    ...
    [
        ...
        ['Она в тот день ждала кого-то?', 'Не знаю, сис', 1],
    ],
    [
        # 56
        ['Можете сказать, кто это мог сделать?', 'Не, сис. У неё врагов вообще не было. Говорю, '
    ...
    [
        ...
        ['Что-то странно проиходило в посленее время?', 'Она не любила парней', 1],
    ],
    [
        # 69
    ...
    [
        ...
        ['Где вы были в вечер?', 'Я была у подруги. Вернулась домой, зашла,'
                                 ' а там лежит он…', 0],
    ...
    [
        ...
        ['Насколько сильны были ваши отношения?', 'Да', 0],
        ['Вы замечали что-то странное?', 'Я спросил, как у него дела, он нервно отмахнулся, стал заикаться', 1],
    ],
    [
        # 82
    ...
    [
        # 84
        ['Вы пытались узнать, что с ним?', 'Нет, больше я стал не спрашивать', 0],
