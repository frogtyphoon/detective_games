...
bot_police = [
    ...
    [
        ...
        ['Подруга', 'Вы сделали свой выбор, детектив', 0],
        ['Парень', 'Вы сделали свой выбор, детектив', 1],
        ['', '', 1],
        ['', '', 1],
    ],
    [
        # 8 Мини диалог
        ['Ещё одно происшевтие... Походу здесь всё запланировано', 'Не могу не согласиться с тобой. Выдвигайся по '
                                                                   'этому адресу "АДРЕСЕСЕ". У нас есть 15 мин', 0],
        ['Хорошо, пора выдвигаться\nСкажите где и сколько у нас есть времени?', 'Ох... ты так насроен. "АДЕРЕС".'
                                                                                ' У нас есть 15 мин', 1],
        ['Понял', 'ага..\n тебя есть 15 мин. Выезжай по адресу "АДРЕССС"', 0],
    ...
    [
        ...
        ['Да это в моей голове, не обращай внимание', 'Хорошо. Выезжай по адресу "АДРЕС" у тебя есть 20 мин', 0],
        ['Какой же ты нудный...', 'Эх...раньше ты был другим\nДавай уже едь по адресу "АДЕРС".'
                                  ' У тебя есть 20 мин', -1],
        ['Да говори куда уже ехать', '"АДЕРС" у тебя есть 20 мин', 0],
    ],
    [
    ...
    [
        ...
        ['Не совсем... Но меняй', 'Зря наверное, но ладно', 0],
    ...
    [
        ...
        ['Срочно, у меня есть важная информация.'
         ...
         ' на ваш сотовый скинул всю известную информацию', 'Выдвигаемся!\nПока криминалист отправит вам досье', 1],
        ...
        ['У меня есть коя какая информация, задержите его.'
         ' Всё отправил на телефон', 'Хорошо, сейчас всё сделем.\nПока криминалист отправит вам досье', 3],
