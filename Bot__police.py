...
bot_police = [
    ...
    [
        ...
        ['Да это в моей голове, не обращай внимание', 'Хорошо. Выезжай по адресу "АДРЕС" у тебя есть 15 мин', 0],
        ['Какой же ты нудный...', 'Эх...раньше ты был другим\nДавай уже едь по адресу "АДЕРС".'
                                  ' У тебя есть 15 мин', -1],
        ['Да говори куда уже ехать', '"АДЕРС" у тебя есть 15 мин', 0],
    ],
]
