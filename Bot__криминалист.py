...
bot_criminalist = [
    [
        ['Кто? впервые слышу...', 'ммм...', 0],
        ['Хорошо, я запомню. Спасибо!', 'Также скажу, что улики могут быть в любом месте.'
                                        ' Чем больше найдешь, тем лечге будеть понять происходящее\n'
                                        'Удачи тебе', 1],
        ['Уяснил. Спасибо, но лучше бы ты закрыл пасть, щенок', 'Я подозревал такое... Ладно, удачи тебе', -1],
        ['Да пошёл ты! я тут царь, а ты говнарь', 'Я подозревал такое... Ладно, удачи тебе', -1],
    ],
    [
        ['Да пососи', 'Мда...', -1],
